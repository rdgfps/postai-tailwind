        ...
        <div className="space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-lg p-6 border-2 border-red-200">
            ...
            <div className="flex items-center justify-between">
              ...
              onClick={() => Swal.fire({title: 'Tem certeza?',
                text: "Esta ação excluirá sua conta permanentemente.",
              }).then((result) => {
                if (result.isConfirmed) {
                  Swal.fire('Excluído!', 'Sua conta foi excluída.', 'success');
                }
                else {
                  Swal.fire('Cancelado', 'Sua conta está segura.', 'info');
                }
              })}>
                Excluir
              </button>
